...
export const submitUdyamApplication = createServerFn({ method: "POST" })
  ...
  .handler(async ({ data, context }) => {
    ...
    const parsed = formSchema.safeParse({
      aadhaar_number: s(app.aadhaar_number),
      pan_number: s(app.pan_number),
      name_as_aadhaar: s(app.name_as_aadhaar),
      name_as_pan: s(app.name_as_pan),
      dob: s(app.dob),
      mobile: s(app.mobile),
      email: s(app.email),
      gender: s(app.gender),
      category: s(app.category),
      business_name: s(app.business_name),
      business_type: s(app.business_type),
      business_start_date: s(app.business_start_date),
      business_address: s(app.business_address),
      state: s(app.state),
      district: s(app.district),
      city: s(app.city),
      village: s(app.village),
      pincode: s(app.pincode),
      ...
      gst_number: s(app.gst_number),
      bank_name: s(app.bank_name),
      ifsc: s(app.ifsc),
      account_number: s(app.account_number),
